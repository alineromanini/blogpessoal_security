...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/alineromanini/blogpessoal_security) dentro da pasta do *Workspace* do STS

```bash
git clone https://github.com/alineromanini/blogpessoal_security.git
```
